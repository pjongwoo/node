...
const option = {
    api_URL  :'Grid_20150827000000000226_1', //레시피 기본정보
    api_URL1 : 'Grid_20150827000000000228_1',//레시피 과정정보
    api_URL2 : 'Grid_20150827000000000227_1', //레시피 재료정보
    apiKey   :'e2237ebde52fb28e6a2d8e19ec9a442ec87e4f1a6fc39b170a29a8c1824b63f4', //apiKey
    type :'json' //return type (json, xml)
  }

router.get('/page/:page', function(req, res, next){ //해당 page의 목록을 뿌려줌
...
router.get('/read/:id/:name', function(req, res, next) {    //id값과 name값으로 레시피 정보 조회
    var id = req.params.id;
    var name = req.params.name
    request.get({   //RECIPE_ID변수로 레시피 과정정보조회
        ...
        let json = JSON.parse(body) //json으로 파싱    
        request.get({   //RECIPE_ID변수로 레시피 재료정보
            ...
            request.get({   //RECIPE_NM_KO변수로 레시피 기본정보 조회
                uri:url, 
